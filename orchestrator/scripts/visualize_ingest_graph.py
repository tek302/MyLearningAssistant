"""Script to visualize the Ingest LangGraph by automatically extracting structure from the compiled graph."""
...
def visualize():
    ...
    mermaid_diagram = generate_mermaid_diagram(structure, "Ingest")
    
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_file = os.path.join(script_dir, "..", "ingest_graph.mmd")
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(mermaid_diagram)
    
    print("=" * 80)
    print("Ingest LangGraph Visualization (Auto-extracted)")
    print("=" * 80)
    print()
    ...
    print("-" * 80)
    png_file = os.path.join(script_dir, "..", "ingest_graph.png")
